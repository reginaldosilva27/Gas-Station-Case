...
async def run():
    ...
    producerproduct = EventHubProducerClient.from_connection_string(conn_str="Endpoint=sb://eh-xxx.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=xxx", eventhub_name="products-topic")
    producerprovider = EventHubProducerClient.from_connection_string(conn_str="Endpoint=sb://eh-xxx.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=xxx", eventhub_name="provider-topic")
